...
<table class="<?php print $class?>" border="1">
  ...
  <tr>
    ...
    <td><?php print drupal_render($form[$key_pre ."_26_2"]);?>其它，请详细说明<?php print drupal_render($form[$key_pre ."_26_3"]);?></td>
  ...
  <tr>
    ...
    <td><?php print drupal_render($form[$key_pre ."_29_3"]);?>其它，请详细说明<?php print drupal_render($form[$key_pre ."_29_4"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_29_5"]);?></td>
