...
<table class="<?php print $class?>" border="1">
  <tr class="title">
    <td class="title" colspan="8"><h2><?php print $table_name?></h2>
    </td>
  </tr>
  <tr>
    <td rowspan="2" width="20%">项目</td>
    <td colspan="4" width="20%">最严重时分级#</td>
    <td rowspan="2" width="25%">处理措施*</td>
    <td rowspan="2" width="10%">转归**</td>
    <td rowspan="2" width="25%">与研究药物关系***</td>
  </tr>
  <tr>
    <td width="5%">I</td>
    <td width="5%">II</td>
  ...
  <tr>
    ...
    <td><?php print drupal_render($form[$key_pre ."_1_7"]);?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><?php print drupal_render($form[$key_pre ."_5_7"]);?></td>
  </tr>
  <tr>
    <td>ALT（IU/L）</td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_6_7"]);?></td>
  </tr>
  <tr>
    <td>AST（IU/L）</td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_7_7"]);?></td>
  </tr>
  <tr>
    <td>ALP（IU/L）</td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_8_7"]);?></td>
  </tr>
  <tr>
    <td>BUN（mmol/L）</td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_9_7"]);?></td>
  </tr>
  <tr>
    <td>Cr（µmol/L）</td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_10_7"]);?></td>
  </tr>
  <tr>
    <td>出血</td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_11_7"]);?></td>
  </tr>
  <tr>
    <td>血尿</td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_12_7"]);?></td>
  </tr>
  <tr>
    <td>口腔炎</td>
    <td><?php print drupal_render($form[$key_pre ."_13_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_13_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_13_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_13_7"]);?></td>
  </tr>
  <tr>
    <td>恶心、呕吐</td>
    <td><?php print drupal_render($form[$key_pre ."_14_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_14_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_14_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_14_7"]);?></td>
  </tr>
  <tr>
    <td>腹泻</td>
    <td><?php print drupal_render($form[$key_pre ."_15_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_15_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_15_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_15_7"]);?></td>
  </tr>
  <tr>
    <td>药物致发热</td>
    <td><?php print drupal_render($form[$key_pre ."_16_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_16_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_16_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_16_7"]);?></td>
  </tr>
  <tr>
    <td>脱发</td>
    <td><?php print drupal_render($form[$key_pre ."_17_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_17_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_17_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_17_7"]);?></td>
  </tr>
  <tr>
    <td>过敏</td>
    <td><?php print drupal_render($form[$key_pre ."_18_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_18_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_18_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_18_7"]);?></td>
  </tr>
  <tr>
    <td>皮肤</td>
    <td><?php print drupal_render($form[$key_pre ."_19_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_19_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_19_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_19_7"]);?></td>
  </tr>  
  <tr>
    <td>肺部</td>
    <td><?php print drupal_render($form[$key_pre ."_20_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_20_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_20_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_20_7"]);?></td>
  </tr>  
  <tr>
    <td>心脏</td>
    <td><?php print drupal_render($form[$key_pre ."_21_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_21_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_21_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_21_7"]);?></td>
  </tr>
  <tr>
    <td>神志</td>
    <td><?php print drupal_render($form[$key_pre ."_22_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_22_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_22_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_22_7"]);?></td>
  </tr>
  <tr>
    <td>周围神经</td>
    <td><?php print drupal_render($form[$key_pre ."_23_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_23_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_23_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_23_7"]);?></td>
  </tr>
  <tr>
    <td>便秘</td>
    <td><?php print drupal_render($form[$key_pre ."_24_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_24_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_24_3"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_24_7"]);?></td>
  </tr>
  <tr>
    <td>局部静脉</td>
    <td><?php print drupal_render($form[$key_pre ."_25_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_25_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_25_3"]);?></td>
  ...
  <tr>
    ...
    <td><?php print drupal_render($form[$key_pre ."_26_7"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_26_8"]);?></td>
  </tr>
  <tr>
    <td>其它，<?php print drupal_render($form[$key_pre ."_27_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_27_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_27_3"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_27_4"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_27_8"]);?></td>
  </tr>
  <tr>
    <td>其它，<?php print drupal_render($form[$key_pre ."_28_1"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_28_2"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_28_3"]);?></td>
    <td><?php print drupal_render($form[$key_pre ."_28_4"]);?></td>
    ...
    <td><?php print drupal_render($form[$key_pre ."_28_8"]);?></td>
  </tr>
</table>
<table>
<tr>
